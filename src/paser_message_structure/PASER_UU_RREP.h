...
public:
    ...
    u_int8_t GFlag; ///< Gateway flag
    std::list<address_list> AddressRangeList; ///< Route list from querying node to forwarding node
    u_int8_t metricBetweenQueryingAndForw; ///< Metric of the route between querying node and forwarding node
    u_int8_t metricBetweenDestAndForw; ///< Metric of the route between destination node and forwarding node
